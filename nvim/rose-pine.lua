...
local function set_highlights()
	...
	local default_highlights = {
		...
		--- Types
		["@type"] = { fg = palette.foam },
		["@type.builtin"] = { fg = palette.foam, italic = styles.italic },
		-- ["@type.definition"] = {},
		-- ["@type.qualifier"] = {},
		...
		["@keyword.import"] = { fg = palette.pine, italic = styles.italic },
		["@keyword.storage"] = { fg = palette.foam },
		["@keyword.repeat"] = { fg = palette.pine, italic = styles.italic },
		["@keyword.return"] = { fg = palette.pine, italic = styles.italic },
		["@keyword.debug"] = { fg = palette.rose },
		["@keyword.exception"] = { fg = palette.pine, italic = styles.italic },
		["@keyword.conditional"] = { fg = palette.pine, italic = styles.italic },
		["@keyword.conditional.ternary"] = { fg = palette.pine, italic = styles.italic },
